...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_iso_83(
     ...
     MO(WIN_FN),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,             KC_PGDN,
        KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
        KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                          KC_RALT,TO(WIN_UNDERSCORE),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
void matrix_scan_user(void) {
    LEADER_DICTIONARY() {
        ...
        SEQ_THREE_KEYS(KC_G, KC_I, KC_T) {
            SEND_STRING("git config --global user.email @james\"thurley.com@\ngit config --global user.name @James Thurley@\n");
        }
